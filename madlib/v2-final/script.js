(function(){
    ...
    function makeMadLib(words){
        const myText = `You <span>${words[0]}</span> out of the grocery store, just have bagged up your groceries in a <span>${words[1]}</span> bag. It is a beautiful <span>${words[2]}</span> day outside and you get distracted watching a <span>${words[3]}</span> dart along in the distance. What you don’t see is the <span>${words[4]}</span> right in front of you, causing you to trip. Your bag <span>${words[5]}</span> out of your arms and <span>${words[6]}</span>. All <span>${words[7]}</span> of your <span>${words[8]}</span> go absolutely everywhere, causing an absolute scene. Unfortunately for you, you are also on the ground and see the <span>${words[3]}</span> from before laughing at you.`;
        // const myText = `You <span>${words[0]}</span> out of the grocery store, just have bagged up your groceries in a <span>${material}</span> bag. It is a beautiful <span>${weather}</span> day outside and you get distracted watching a <span>${animal}</span> dart along in the distance. What you don’t see is the <span>${object}</span> right in front of you, causing you to trip. Your bag <span>${verb1}</span> out of your arms and <span>${verb2}</span>. All <span>${number}</span> of your <span>${fruit}</span> go absolutely everywhere, causing an absolute scene. Unfortunately for you, you are also on the ground and see the <span>${animal}</span> from before laughing at you.`;
